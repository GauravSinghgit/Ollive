"""Standalone Frontier assistant app — Gemini 2.0 Flash."""
...
def get_assistant(system_prompt: str):
    ...
    if _assistant is None:
        _assistant = FrontierAssistant(system_prompt=system_prompt)
    else:
...
with gr.Blocks(title="Frontier Assistant — Groq Llama-3.3-70B") as demo:
